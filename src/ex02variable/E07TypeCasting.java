...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		자동형변환 : 작은자료형의 데이터를 큰자료형에 대입할때
			자동으로 형변환이 일어난다.
		 */
		byte b1 = 65;
		short s1;
		//byte가 short보다 작은 자료형이므로 자동형변환 된다.
		s1 = b1;
...
//		char ch1 = b1;
		...
		/*
		명시적 형변환 : 큰 상자의 자료를 작은 상자의 자료형에
			할당해야 할때 사용한다. 단, 자료의 손실이 있을수 있으므로
			필요한 경우에만 사용해야한다.
		 */
		...
		/*
		서식문자 사용시 %.2f는 정부수는 모두 출력하고, 소수이하는 2자리까지만 표현한다.
		 */
		
		/*
		문자는 메모리에 저장시 아스키코드로 저장되므로 int형 과의 연산을
		진행한 후 문자로 표현하고 싶다면 char형으로 강제형변환 하면된다.
		 */
		char ch3 = 'A',ch4;
		int num4 = 2;
//		ch4 = ch3 + num4;
