...
public class E05TwoDimArray02 {
	...
	public static void main(String[] args) {
		...
		/*
		arr2Dim(배열명).length => 배열의 행 크기를 반환한다.
		arr2Dim(배열명)[n].length => 배열의 열 크기를 반환한다.
		 */
		//배열의 행 길이
		...
		1. 2차원 배열ㅇ르 선언한다. 세로2, 가로4
		2. 난수를 이용하여 배열ㅇ르 초기화한다. (0~100사이)
