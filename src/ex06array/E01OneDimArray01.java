...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		일반적으로 반복문(for)을 사용한다. while문은 가능하지만 번거롭다.
		...
		/*
		인스턴스(객체)배열 : 기본자료형을 저장하는 배열이 아닌 인스턴스의
		 참조값을 저장할 목적으로 생성한 배열을 말한다. 사용법은 동일하다.
		 */
		...
		초기값의 갯수를 통해 배열의 크기를 결정할 수 있다. 따라서
		이런 경우에는 크기는 생략하도록 약속되어있다.
		 */
