...
abstract class PersonlNumberStorageAbsP {
	public abstract void addPersonalInfo(String jumminNum,String name);
	public abstract String searchPersonalInfo(String juminNum);
}

class PersonalInfoDTOP{
	private String name;
	private String juminNum;
	//멤버변수 선언 후 자동생성 하세요.
	public PersonalInfoDTOP(String name, String juminNum) {
		this.name = name;
...
class PersonalNumberStorageExtP extends PersonlNumberStorageAbsP{
	
	PersonalInfoDTOP[] personalArr;
	int numOfPerInfo;
	public PersonalNumberStorageExtP(int arrSize) {
...
public class E02AbstractToInterface1P {
