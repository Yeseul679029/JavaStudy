...
1.이 경우 부모타입의 참조변수는 부모로부터 상속받은 멤버까지만 접근할
수있다.
...
public class E11Polymorphism {
	...
	public static void main(String[] args) {
		...
		//동질화의 경우 인스턴스 전체를 접근할 수있다.
		homeChild.childMember = 10;
		homeChild.parentMenber =100;
		...
		할 수 없다. 만약 접근해야 한다면 자식타입으로 강제형변환
		(다운캐스팅) 해야 한다. */
		Parent parent1 = homeChild;
		parent1.parentMenber = 1;
...
//		parent1.childMember = 1;
		...
		*/
		...
		/* 자식타입으로 형변환 이후에 해당 참조변수를 통해 
		바식멤버에 접근한다. 위와 동일한 방법이다.*/
