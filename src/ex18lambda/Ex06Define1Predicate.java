...
Consumer<T> : 매개변수 O, 리턴값X
Function<T,E> : 둘다있음
 */
public class Ex06Define1Predicate {

	public static void main(String[] args) {
		//테스트를 위한 2개의 인스턴스를 생성한다.
		...
		Predicate<T> 
		-사전적의미 : ~에 근거를 두다
		-매개변수와 boolean리턴값이 있는 추상메서드 test()가 정의
		되어있다.
		...
		람다식을 정의한다. 매개변수로 Human객체를 전달하고, getter
		인 getGender()를 통해 성별이 '남'인경우 true를 반환하도록
		정의되어있다.
		 */
	...
	두번째 매개변수는 4개의 Human객ㅊ체가 저장된 List컬렉션이다.
	 */
