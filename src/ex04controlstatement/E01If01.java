...
if문 형식1
	...
	-if문의 조건문은 반드시 비교식 혹은 놀리식이어야 한다.
	-즉 결과값이 boolean형으로 true/false를 반환해야한다.
...
//		}
		...
		//if문의 조건은 아래와 같이 boolean값을 반환할수있는 조건식이어야 한다.
		if(num%2==0) {
		...
		/*
		조건 검사후 실행할 문장이 1개ㅐ인 경우에는 중괄호를 생략할 수 있다.
	 ...
	 */
		...
		System.out.println("입력한 문자의 아스키코드: "+asciiCode);
		
		/*
		아스키코드를 알고있을때의 구현방법. 문자 0과 9는 아스키코드 48,57에
		해당하므로 구간내에 있는지 확인하면 된다.
		 */
		...
		/*
		아스키코드를 모를때 구현하는 방법으로 문자 '0'과 '9'는 메모리에 저장시
